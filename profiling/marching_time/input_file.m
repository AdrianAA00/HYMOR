...
solution.boundary_conditions.boundary_eta0.name        = 'no_slip_adiabatic'; 
solution.boundary_conditions.boundary_eta1.name        = 'no_slip_adiabatic';  
solution.boundary_conditions.boundary_chi0.name        = 'no_slip_adiabatic';
solution.boundary_conditions.boundary_chi1.name        = 'no_slip_adiabatic';
