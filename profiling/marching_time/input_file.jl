...
solution["boundary_conditions"]["boundary_eta0"] = Dict{String, Any}("name" => "no_slip_adiabatic") 
solution["boundary_conditions"]["boundary_eta1"] = Dict{String, Any}("name" => "no_slip_adiabatic")
solution["boundary_conditions"]["boundary_chi0"] = Dict{String, Any}("name" => "no_slip_adiabatic")
solution["boundary_conditions"]["boundary_chi1"] = Dict{String, Any}("name" => "no_slip_adiabatic")
...
solution["time_integration"]["CFL"]               = 1e-20         # CFL number for adaptive time stepping
