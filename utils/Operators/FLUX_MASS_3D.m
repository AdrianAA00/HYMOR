function s = FLUX_MASS_3D(s)
% FLUX_MASS_3D - Compute the inviscid mass flux for the 3D axisymmetric continuity equation.
%
%   Evaluates the net mass flux through the east, west, south, and north
%   faces of each interior cell using midpoint interpolation and midpoint
%   quadrature, both second-order accurate on rectangular cells. This is
%   the axisymmetric (3D) variant; no front/back face contribution arises
%   for the continuity equation because the azimuthal velocity is zero.
%   The resulting flux is normalised by cell volume to yield the
%   cell-averaged rate of change of density.
%
% Syntax:
%   s = FLUX_MASS_3D(s)
%
...
%   - Front/back faces do not contribute to mass flux in axisymmetric mode.
%
