...
%   hoop stress (tau_theta_theta) and the geometric v/r source term in the
...
%
%   Outputs:
%       s - Updated s struct with axisymmetric viscous
...
% Part of: Hypersonics Stability MATLAB Solver - Operators Module
    ...
    x_face_1 = (s.mesh.x_Ext(2:end, 2:end-1) + s.mesh.x_Ext(1:end-1, 2:end-1)) / 2;
    x_face_2 = (s.mesh.x_Ext(2:end-1, 2:end) + s.mesh.x_Ext(2:end-1, 1:end-1)) / 2;

    u_face_1 = (u(2:end, 2:end-1) + u(1:end-1, 2:end-1)) / 2;
    u_face_2 = (u(2:end-1, 2:end) + u(2:end-1, 1:end-1)) / 2;
    ...
    tau_theta_theta_cell = (tau_theta_theta_1(1:end-1, :) + tau_theta_theta_1(2:end, :) + ...
                            tau_theta_theta_2(:, 1:end-1) + tau_theta_theta_2(:, 2:end)) / 4;

    % Radial coordinate at cell centers
    x_cell = s.mesh.x_Ext(2:end-1, 2:end-1);
    ...
    s.flux.rho_u = s.flux.rho_u - tau_theta_theta_cell ./ x_cell;
