...
#   boundary type (circle, MSL, blunt_cone, or wedge/LIA).
#
#   s = SHOCK_LINE_INITIALIZATION(s)
#
#   Inputs:
#       s - (Dict) Solution struct containing mesh and geometry data.
#
#   Outputs:
#       s - (Dict) Updated struct with initialized shock point arrays.
#
#   Notes:
...
function SHOCK_LINE_INITIALIZATION(s::Dict{String,Any})
    ...
    if !s["restart"]
        ...
        elseif boundary_type == "blunt_cone"
