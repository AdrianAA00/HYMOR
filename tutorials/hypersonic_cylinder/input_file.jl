# input_file.jl - Input configuration for hypersonic flow over a cylinder
#
# Description:
...
#   is loaded by main.jl via LOAD_INPUT_VARIABLES and populates the
#   'solution' dict.
#
# Usage:
...
solution["boundary_conditions"]["boundary_eta0"] = Dict{String, Any}("name" => "no_slip_adiabatic")  # Wall BC
solution["boundary_conditions"]["boundary_eta1"] = Dict{String, Any}("name" => "shock")              # Upper (shock) BC
solution["boundary_conditions"]["boundary_chi0"] = Dict{String, Any}("name" => "symmetry")           # Inflow/symmetry BC
solution["boundary_conditions"]["boundary_chi1"] = Dict{String, Any}("name" => "outflow_NRCBC")      # Outflow BC
...
solution["running_plot"]["variable"]  = ["CO2", "rho", "vort"]  # Variables to plot: 'rho', 'u', 'v', 'p', 'T', 'div_U', 'vort', etc.
